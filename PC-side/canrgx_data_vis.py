...
class canrgx_data_visualizer():
    ...
    def visualize_data(self):
        ...
        axs[1][1].plot(self.data_time, self.tmp_record[:,0],label='Temp A')
        axs[1][1].plot(self.data_time, self.tmp_record[:,1],label='Temp B')
        axs[1][1].plot(self.data_time, self.tmp_record[:,2],label='Temp C')
        axs[1][1].plot(self.data_time, self.tmp_record[:,3],label='Temp D')
        axs[1][1].plot(self.data_time, self.tmp_record[:,4],label='Temp E')
        axs[1][1].plot(self.data_time, self.tmp_record[:,5],label='Temp F')
