...
\begin{itemize}
	...
	\item $H_x$, $H_y$, $H_z$ (14 bits each, full-scale range $\pm 4800 \ [uT]$)
\end{itemize}

Note that these full-scale ranges were the defaults and also the most suitable since they provided the highest resolution for the window of interest.
\newline
\newline
