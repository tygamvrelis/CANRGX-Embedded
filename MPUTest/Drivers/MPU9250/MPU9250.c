...
//	/* This function is useful for relieving deadlocks that may arise on the I2C bus.
//	 * It does this by generating clocks until 9 stop bits are sent, or the slave
//	 * exits its ACK state.
//	 *
